...
centesimo/
  ...
  .env.example
  docs/
    ARCHITETTURA_CENTESIMO.md   (questo file)
...
```
Stai implementando "Centesimo", un tool personale di gestione finanziaria.

REGOLE OBBLIGATORIE:

1. Prima di scrivere qualunque codice, leggi per intero docs/PROJECT_MEMORY.md e
   docs/ARCHITETTURA_CENTESIMO.md. Non proporre soluzioni già scartate lì elencate.
2. Le decisioni architetturali in ARCHITETTURA_CENTESIMO.md sono chiuse: non rimetterle
